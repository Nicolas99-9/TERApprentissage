...
/*     */   
/*  32 */   protected void setTabSize(int i) { this.tabSize = i; }
/*  33 */   protected int getTabSize(int i) { return this.tabSize; }
/*     */   
/*     */ 
...
/*  47 */         System.arraycopy(this.buffer, 0, newbuffer, 
/*  48 */           this.bufsize - this.tokenBegin, this.bufpos);
...
/*     */     try {
/*     */       int i;
/* 112 */       if ((i = this.inputStream.read(this.buffer, this.maxNextCharInd, 
/* 113 */         this.available - this.maxNextCharInd)) == -1)
/*     */       {
...
/*     */     }
/* 279 */     this.prevCharIsLF = (this.prevCharIsCR = 0);
...
/*     */     }
/* 364 */     return 
/* 365 */       new String(this.buffer, this.tokenBegin, this.bufsize - this.tokenBegin) + new String(this.buffer, 0, this.bufpos + 1);
/*     */   }
/*     */   
...
/*     */     }
/*     */     else {
/* 376 */       System.arraycopy(this.buffer, this.bufsize - (len - this.bufpos - 1), ret, 0, 
/* 377 */         len - this.bufpos - 1);
...
/*     */     }
/*     */     
/* 408 */     int i = 0;int j = 0;int k = 0;
/* 409 */     int nextColDiff = 0;int columnDiff = 0;
/*     */     
/* 411 */     while ((i < len) && 
/* 412 */       (this.bufline[(j = start % this.bufsize)] == this.bufline[(k = ++start % this.bufsize)]))
/*     */     {
...
/* Location:              C:\Users\nicol_000\Downloads\opinosis-summarizer\OpinosisSummarizer-1.0\opinosis.jar!\org\textbug\lucene\html\SimpleCharStream.class
